...
$(document).ready(function () {
  ...
  var firstTelefone, firstEmail;
  var telefoneElement = $('select[name="telefoneTipo"]').next('.button-add');
  var emailElement = $('select[name="emailTipo"]').next('.button-add');

  var addTelefoneField = function addTelefoneField() {
    return addEmailTelefone(telefoneElement);
  };

  var addEmailField = function addEmailField() {
    return addEmailTelefone(emailElement);
  };
