...
<div id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" id="div-cpf" style="display: none">
                        ...
                        class="form-control set-required" id="cpf" value="{{ $fornecedor->pessoable->cpf }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6" id="div-nome" style="display: none">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set-required" id="nome" name="nome" value="{{ $fornecedor->pessoable->nome }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3" id="div-apelido" style="display: none">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set-required" id="apelido" name="apelido" value="{{ $fornecedor->pessoable->apelido }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3" id="div-rg" style="display: none">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set-required" id="rg" name="rg" value="{{ $fornecedor->pessoable->rg }}" disabled>
                        </div>
                    </div>
    ...
    <div id="dadosFornecedor" class="collapse show" role="tabpanel" aria-labelledby="dadosForncedor">
        <div class="card-body">
            <div class="form-check form-check-inline mb-3">
                <input disabled class="form-check-input" type="radio" name="tipoPessoa" id="PessoaJuridicaRadio" value="juridica">
                <label class="form-check-label" for="PessoaJuridicaRadio">Pessoa Jurídica</label>
            </div>
            <div class="form-check form-check-inline mb-3">
                <input disabled checked class="form-check-input" type="radio" name="tipoPessoa" id="PessoaFisicaRadio" value="fisica">
                <label class="form-check-label" for="PessoaFisicaRadio">Pessoa Física</label>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3" id="div-cnpj">
                    <div class="form-group">
                        ...
                        <input type="tel" value="{{$fornecedor->pessoable->cnpj}}" name="cnpj" class="form-control" id="cnpj" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-6" id="div-razao-social">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$fornecedor->pessoable->razao_social}}" class="form-control set-required" id="razaoSocial" name="razaoSocial"
                            disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3" id="div-nome-fantasia">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$fornecedor->pessoable->nome_fantasia}}" class="form-control set-required" id="nomeFantasia" name="nomeFantasia"
                            disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3" id="div-indicador-inscricao-estadual">
                    <div class="form-group">
                        ...
                        <select disabled id="indicadorInscricaoEstadual" name="indicadorInscricaoEstadual"
                            class="form-control set-required" required>
                            <option selected >{{ $fornecedor->pessoable->indicador_inscricao_estadual }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-3" id="div-inscricao-estadual">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control set-required" value="{{$fornecedor->pessoable->inscricao_estadual}}" id="inscricaoEstadual"
                ...
                <div class="col-md-3" id="div-inscricao-municipal">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control set-required" value="{{$fornecedor->pessoable->inscricao_municipal}}" id="inscricaoMunicipal"
                            name="inscricaoMunicipal" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3" id="div-situacao-cnpj">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control set-required" value="{{$fornecedor->pessoable->situacao_cnpj}}" id="situacaoCNPJ" name="situacaoCNPJ"
                            disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3" id="div-recolhimento">
                    <div class="form-group">
                        ...
                        <select id="recolhimento" name="recolhimento" class="form-control set-required" disabled>
                    ...
                    <div class="col-md-6" id="telefoneContato">
                        ...
                        <span class="telefone-field">
                            <div class="telefone-principal row col-md6">
                                ...
                                <input type="text" class="form-control telefone" name="telefone" value="{{ $fornecedor->pessoable->telefone }}">
                                </div>
                                ...
                                <div class="form-group  col-6">
                                    ...
                                    <div class="input-form">
                                        <select id="telefoneTipo" name="telefoneTipo" class="form-control group-error"
                                            required>
                        ...
                        <span class="email-field">
                            ...
                            <div class="email-principal row">
                                ...
                                <div class="form-group  col-6">
                                    ...
                                    <div class="input-form">
                                        <select name="emailTipo" name="emailTipo" class="form-control group-error"
                                            required>
                                            <option selected disabled>Selecione</option>
        ...
        <div class="collapse show" role="tabpanel" aria-labelledby="contatosAdicionais">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set-required" name="contato-adicional[][nome]">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3" id="div-inscricao-minucipal">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set-required" name="contato-adicional[][empresa]">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3" id="div-inscricao-minucipal">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set-required" name="contato-adicional[][cargo]">
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <div class="btn btn-danger float-right remove-contact" data-toggle="tooltip"
                    title="Remover contato adicional" data-remove="contatos-adicional"><i class="fa fa-trash"></i></div>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="cep" name="cep" value="{{$fornecedor->endereco->cep}}" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="logradouro" name="logradouro" value="{{$fornecedor->endereco->logradouro}}" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numero" name="numero" value="{{$fornecedor->endereco->numero}}" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="complemento" name="complemento" value="{{$fornecedor->endereco->complemento}}" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bairro" name="bairro" value="{{$fornecedor->endereco->bairro}}" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="pontoReferencia" name="pontoReferencia" value="{{$fornecedor->endereco->ponto_referencia}}" disabled>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="isCondominio" name="isCondominio" class="form-control" disabled>
                            <option>{{ ($fornecedor->endereco->is_condominio) ? 'Sim' : 'Não' }}</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-md-3 enderecoCondominio">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set-required" id="enderecoCondominio"
                                name="enderecoCondominio" value="{{$fornecedor->endereco->endereco_condominio}}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 numeroCondominio" >
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control set-required" id="numeroCondominio"
                                name="numeroCondominio" value="{{$fornecedor->endereco->numero_condominio}}" disabled>
                        </div>
                    </div>
